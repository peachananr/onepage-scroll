 ...
 *
 * This is the extended version by bluefirex. For more information
 * visit the git repository at
 * https://github.com/bluefirex/onepage-scroll
 *
 * ========================================================== */
...
!function($){
	...
	$.fn.onepage_scroll = function(options){
		...
		if(settings.pagination == true) {
			...
			var paginationEl = $('.onepage-pagination');
			posTop = (paginationEl.height() / 2) * -1;

			paginationEl.css("margin-top", posTop);
		}
