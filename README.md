...
$(".main").onepage_scroll({
   ...
   scrollEvents: true               // You can set the plugin to either scroll when a scrolling event is detected, or to ignore these events.  Helpful if you want to only scroll programmatically using the public methods.
});
````
